...
public class StringImmutability {
    public static void main(String[] args) {
         ...
         * Next, the VM creates another new String "java rules", but nothing refers to it. So, the second 
         * String is instantly lost. We can’t reach it.
         * 
         */

        /**
         * Almost every method, applied to a String object in order to modify it, creates new String object. 
         * So, where do these String objects go? Well, these exist in memory, and one of the key goals of any 
         * programming language is to make efficient use of memory.As applications grow, 
         * it’s very common for String literals to occupy large area of memory, which can even cause redundancy. 
         ...
         *  
         * Here comes the point of making String objects immutable: In the String constant pool, a String object is likely to 
         * have one or many references. If several references point to same String without even knowing it, 
